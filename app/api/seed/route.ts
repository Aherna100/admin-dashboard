...
export async function GET() {
  ...
  return sql`INSERT INTO products (id, image_url, name, status, price, stock, available_at)
        VALUES (1, 'https://uwja77bygk2kgfqe.public.blob.vercel-storage.com/smartphone-gaPvyZW6aww0IhD3dOpaU6gBGILtcJ.webp', 'Smartphone X Pro', 'active','999.00', 150, now())`
